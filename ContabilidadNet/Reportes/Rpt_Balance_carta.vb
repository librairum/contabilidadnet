...
Public Class Rpt_Balance_carta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_Balance_carta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Balance_carta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Balance_carta = New Rpt_Balance_carta()
        rpt.Site = Me.Site
        Return rpt
    End Function
