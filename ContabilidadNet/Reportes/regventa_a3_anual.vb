...
Public Class regventa_a3_anual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.regventa_a3_anual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedregventa_a3_anual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As regventa_a3_anual = New regventa_a3_anual()
        rpt.Site = Me.Site
        Return rpt
    End Function
