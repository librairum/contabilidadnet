...
Public Class Rpt_BalanceCom_PLE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_BalanceCom_PLE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_BalanceCom_PLE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_BalanceCom_PLE = New Rpt_BalanceCom_PLE()
        rpt.Site = Me.Site
        Return rpt
    End Function
