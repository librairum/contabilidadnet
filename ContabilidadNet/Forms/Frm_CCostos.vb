...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub TraeCCostos()
        Try
            Vista = objSql.TraerDataTable("sp_Con_Trae_Centros_Costo", gbcodempresa, "ccb02cod ASC", gbano).DefaultView
...
#End Region
    ...
    Private Sub Frm_Referencias_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            '
            Me.Text = "Maestro de centro de costos"
    ...
    Sub eliminar()
        ...
        Try
            ...
            a = objSql.Ejecutar2("sp_Con_Del_Centro_Costo", gbcodempresa, gbano, txtCodigo.Text.Trim, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("sp_Con_Ins_Centro_Costo", gbcodempresa, gbano, txtCodigo.Text.Trim, txtDescri.Text.Trim, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("sp_Con_Upd_Centro_Costo", gbcodempresa, gbano, txtCodigo.Text.Trim, txtDescri.Text.Trim, "")
                ' Asigno los Valores a los Parametros del Query
            Else
