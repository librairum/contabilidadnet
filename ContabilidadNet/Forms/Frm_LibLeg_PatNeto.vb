Option Explicit On
Option Strict On
Public Class Frm_LibLeg_PatNeto
...
#Region "Traer Informacion de Base de Datos"
    Sub Traeimportacion()
        Try
            vistahelp = objSql.TraerDataTable("Spu_Con_Trae_PerAntCamPatNeto", gbcodempresa).DefaultView
    ...
    Sub TraeEstructura()
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_EstCamPatNeto", gbcodempresa, gbano, gbmes).DefaultView
...
#Region "Metodos de Mantenimiento"
    ...
    Sub TraerAyuda(ByVal index As Integer, ByVal boton As Button)
        ...
        Try
            ...
            Select Case index
                Case 0 'Importar
                    tblhelp.Columns(0).DataField = "cc01Anio"
                    tblhelp.Columns(1).DataField = "cc01Mes"
                    Me.Traeimportacion()
            End Select
        ...
        Try
            Select Case indice
                Case 0
                    ...
                    anioanterior = tblhelp.Columns("cc01Anio").Value.ToString
                    mesanterior = tblhelp.Columns("cc01Mes").Value.ToString
                    ...
                    If MessageBox.Show("¿Esta Seguro de importar datos del año : " & anioanterior, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        a = objSql.Ejecutar2("Spu_Con_Ins_PerAntCamPatNeto", gbcodempresa, gbano, gbmes, anioanterior, mesanterior, "")
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txtcapital.Text = filaactiva("cc01Capital").ToString
                txtCapitalAdicional.Text = filaactiva("cc01CapitalAdicional").ToString
                txtAccionesInversion.Text = filaactiva("cc01AccionesdeInversión").ToString
                txtExcedenteRevalua.Text = filaactiva("cc01ExcedentedeRevaluación").ToString
                txtreservalegal.Text = filaactiva("cc01ReservaLegal").ToString
                txtotrasreservas.Text = filaactiva("cc01OtrasReservas").ToString
                txtresultadoAcum.Text = filaactiva("cc01ResultadosAcumulados").ToString
                txttotal.Text = filaactiva("cc01TOTAL").ToString
                txtdescripcion.Text = filaactiva("cc01descripcion").ToString
                txtResultadoNoRealizado.Text = filaactiva("cc01ResultadosNoRealizados").ToString
                txtDifeConversion.Text = filaactiva("cco01Diferencia_Conversion").ToString
                txtAjustePatrimonio.Text = filaactiva("cc01Ajuste_Patrimonio").ToString
                txtResultadoNetoEjercicio.Text = filaactiva("cc01Resultado_Neto_Ejercicio").ToString
                txtResultadoEjercicio.Text = filaactiva("cc01Resultado_Ejercicio").ToString
                txtCodigoPLE.Text = filaactiva("cc01codigoPLE").ToString
...
#End Region
    ...
    Private Sub Frm_LibLeg_PatNeto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.Text = Frm_LibrosLegales.rbtrepauxiliares_19.Text
            '
    ...
    Sub eliminar()
        ...
        Try
            ...
            Dim a As Array = Array.CreateInstance(GetType(Object), 2, 10)
            a = objSql.Ejecutar2("Spu_Con_Del_EstCamPatNeto", gbcodempresa, gbano, gbmes, correlativo, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        Try
            ...
            If String.IsNullOrEmpty(txtcapital.Text) Then
                txtcapital.Text = "0.00"
            End If
            If String.IsNullOrEmpty(txtCapitalAdicional.Text) Then
                txtCapitalAdicional.Text = "0.00"
            End If
            If String.IsNullOrEmpty(txtAccionesInversion.Text) Then
                txtAccionesInversion.Text = "0.00"
            End If
            If String.IsNullOrEmpty(txtExcedenteRevalua.Text) Then
                txtExcedenteRevalua.Text = "0.00"
            End If
            If String.IsNullOrEmpty(txtreservalegal.Text) Then
                txtreservalegal.Text = "0.00"
            End If
            If String.IsNullOrEmpty(txtotrasreservas.Text) Then

                txtotrasreservas.Text = "0.00"
            End If
            If String.IsNullOrEmpty(txtresultadoAcum.Text) Then
                txtresultadoAcum.Text = "0.00"
            End If
            ...
            End If
            'NUEVOS 
            If String.IsNullOrEmpty(txtResultadoNoRealizado.Text) Then
                txtResultadoNoRealizado.Text = "0.00"
            End If

            If String.IsNullOrEmpty(txtDifeConversion.Text) Then
                txtDifeConversion.Text = "0.00"
            End If

            If String.IsNullOrEmpty(txtAjustePatrimonio.Text) Then
                txtAjustePatrimonio.Text = "0.00"
            End If

            If String.IsNullOrEmpty(txtResultadoNetoEjercicio.Text) Then
                txtResultadoNetoEjercicio.Text = "0.00"
            End If

            If String.IsNullOrEmpty(txtResultadoEjercicio.Text) Then
                txtResultadoEjercicio.Text = "0.00"
            End If
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_EstCamPatNeto", gbcodempresa, gbano, gbmes, correlativo, txtdescripcion.Text, CDbl(txtcapital.Text), CDbl(txtCapitalAdicional.Text), CDbl(txtAccionesInversion.Text), CDbl(txtExcedenteRevalua.Text), CDbl(txtreservalegal.Text), _
                                        CDbl(txtotrasreservas.Text), CDbl(txtresultadoAcum.Text), CDbl(txttotal.Text), CDbl(txtResultadoNoRealizado.Text), CDbl(txtDifeConversion.Text), CDbl(txtAjustePatrimonio.Text), CDbl(txtResultadoNetoEjercicio.Text), CDbl(txtResultadoEjercicio.Text), txtCodigoPLE.Text, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_EstCamPatNeto", gbcodempresa, gbano, gbmes, correlativo, txtdescripcion.Text, CDbl(txtcapital.Text), CDbl(txtCapitalAdicional.Text), CDbl(txtAccionesInversion.Text), CDbl(txtExcedenteRevalua.Text), CDbl(txtreservalegal.Text), _
                                        CDbl(txtotrasreservas.Text), CDbl(txtresultadoAcum.Text), CDbl(txttotal.Text), CDbl(txtResultadoNoRealizado.Text), CDbl(txtDifeConversion.Text), CDbl(txtAjustePatrimonio.Text), CDbl(txtResultadoNetoEjercicio.Text), CDbl(txtResultadoEjercicio.Text), txtCodigoPLE.Text, "")
            ElseIf accionMante = "I" Then
                a = objSql.Ejecutar2("Spu_Con_Inserta_EstCamPatNeto", gbcodempresa, gbano, gbmes, correlativo, txtdescripcion.Text, CDbl(txtcapital.Text), CDbl(txtCapitalAdicional.Text), CDbl(txtAccionesInversion.Text), CDbl(txtExcedenteRevalua.Text), CDbl(txtreservalegal.Text), _
                                        CDbl(txtotrasreservas.Text), CDbl(txtresultadoAcum.Text), CDbl(txttotal.Text), CDbl(txtResultadoNoRealizado.Text), CDbl(txtDifeConversion.Text), CDbl(txtAjustePatrimonio.Text), CDbl(txtResultadoNetoEjercicio.Text), CDbl(txtResultadoEjercicio.Text), txtCodigoPLE.Text, "")
            Else
