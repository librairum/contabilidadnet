...
Public Class Rpt_TipoCambio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_TipoCambio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_TipoCambio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_TipoCambio = New Rpt_TipoCambio()
        rpt.Site = Me.Site
        Return rpt
    End Function
