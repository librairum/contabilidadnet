...
Public Class Frm_RegistrarVentas
...
#End Region
    ...
    Sub TraerAyudaVisible(ByVal index As Integer, ByVal descripcion As String, ByVal boton As Button)
        ...
        Try
            ...
            Select Case index
                Case 0
                    'CONCEPTO
                    tblhelp.Columns(0).DataField = "CO08ITEM"
                    tblhelp.Columns(1).DataField = "CO08DESCRIPCION"
                    tblhelp.Columns(2).DataField = "CO08ASIENTOTIPOCOD"
                    tblhelp.Columns(3).DataField = "ccc03des"
                    tblhelp.Columns(4).DataField = "ccc03lib"
                    tblhelp.Columns(5).DataField = "CO08NOMENCLATURA"
    ...
    Sub TraerAyuda(ByVal index As Integer, ByVal descripcion As String, ByVal boton As Button)
        ...
        Try
            ...
            Select Case index
                Case 0
                    'CONCEPTO
                    tblhelp1_bloque.Columns(0).DataField = "CO08ITEM"
                    tblhelp1_bloque.Columns(1).DataField = "CO08DESCRIPCION"
                    tblhelp1_bloque.Columns(2).DataField = "CO08ASIENTOTIPOCOD"
                    tblhelp1_bloque.Columns(3).DataField = "ccc03des"
                    tblhelp1_bloque.Columns(4).DataField = "ccc03lib"
                    tblhelp1_bloque.Columns(5).DataField = "CO08NOMENCLATURA"
    ...
    Private Sub TraerConcepto_AsientoTipo(ByVal Descripcion As String, ByVal TipoGrid As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_MotivoDocVentas_AsientoTipo", gbcodempresa, gbano, Descripcion).DefaultView
            TipoGrid.SetDataBinding(Vista, Nothing, True)
    ...
    Private Sub CrearColumnas()
        ...
        Try
            ...
            dt.Columns.Add("Fecha_Vcto_Pago", GetType(String))
            dt.Columns.Add("Tipo_CP_Doc", GetType(String))
            ...
            dt.Columns.Add("BI_Gravada", GetType(Decimal))
            dt.Columns.Add("Dscto_BI", GetType(Decimal))
            dt.Columns.Add("IGV_IPM", GetType(Decimal))
            dt.Columns.Add("Dscto_IGV_IPM", GetType(Decimal))
            dt.Columns.Add("Mto_Exonerado", GetType(Decimal))
            dt.Columns.Add("Mto_Inafecto", GetType(Decimal))
            dt.Columns.Add("ISC", GetType(Decimal))
            dt.Columns.Add("BI_Grav_IVAP", GetType(Decimal))
            dt.Columns.Add("IVAP", GetType(Decimal))
            dt.Columns.Add("ICBPER", GetType(Decimal))
            dt.Columns.Add("Otros_Tributos", GetType(Decimal))
            dt.Columns.Add("Total_CP", GetType(String))
            ...
            dt.Columns.Add("CAR_SUNAT", GetType(String))
            ...
            Me.tblconsulta.Splits(1).DisplayColumns("CAR_SUNAT").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("Fecha_emision").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("Fecha_Vcto_Pago").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("Tipo_CP_Doc").Visible = False
            ...
            Me.tblconsulta.Splits(1).DisplayColumns("BI_Gravada").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("Dscto_BI").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("IGV_IPM").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("Dscto_IGV_IPM").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("Mto_Exonerado").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("Mto_Inafecto").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("ISC").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("BI_Grav_IVAP").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("IVAP").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("ICBPER").Visible = False
            Me.tblconsulta.Splits(1).DisplayColumns("Otros_Tributos").Visible = False
            ...
            'tblconsulta.Splits(0).DisplayColumns("ccc01numer").Width = 100
    ...
    Private Sub Cargar()
        ...
        Try
            ...
            dt = objSql.TraerDataTable("Spu_Con_Trae_SireVsRegVentas", gbcodempresa, gbano, gbmes, "SIRESI_VENTASNO")
            ...
            If dt.Rows.Count > 0 Then
                Me.tblconsulta.Splits(1).FilterBar = False
                ...
                For Each fila As DataRow In dt.Rows
                    ...
                    newRow("CAR_SUNAT") = fila("SireCAR_SUNAT")
                    newRow("Fecha_emision") = fila("SireFecha_emision")
                    newRow("Fecha_Vcto_Pago") = fila("SireFecha_Vcto_Pago")
                    newRow("Tipo_CP_Doc") = fila("SireTipo_CP_Doc")
                    ...
                    newRow("Razon_Social_2") = fila("SireRazon_Social2")

                    newRow("BI_Gravada") = fila("SireBI_Gravada")

                    newRow("IGV_IPM") = fila("SireIGV_IPM")

                    newRow("Dscto_IGV_IPM") = fila("SireDscto_IGV_IPM")

                    newRow("Mto_Exonerado") = fila("SireMto_Exonerado")

                    newRow("Mto_Inafecto") = fila("SireMto_Inafecto")
                    newRow("ISC") = fila("SireISC")
                    newRow("BI_Grav_IVAP") = fila("SireBI_Grav_IVAP")
                    newRow("IVAP") = fila("SireIVAP")
                    newRow("ICBPER") = fila("SireICBPER")
                    newRow("Otros_Tributos") = fila("SireOtros_Tributos")
            ...
            Me.tblconsulta.Splits(1).FilterBar = True
        Catch ex As Exception
    ...
    Private Sub GuardarxBloque(ByVal TipoInsercion As String)
        ...
        Try
            ...
            If TipoInsercion = "UNITARIO" Then
                ...
                registrosSeleccionados.Add(tblconsulta.Item(tblconsulta.Row, "CAR_SUNAT") & "|" &
                ...
                Dim dt As Array = objSql.Ejecutar2("Spu_Con_Ins_VoucherSireVentas", gbcodempresa, gbano, gbmes, xmlCadena, flag, "")
            ...
            ElseIf TipoInsercion = "BLOQUE" Then
                ...
                Dim Letra As String = Funciones.Funciones.ExtraerLetras(txtNomenclatura.Text)
                Dim Numero As String = Funciones.Funciones.ExtraerParteNumerica(txtNomenclatura.Text)
                ...
                For Each filaSeleccionada In tblconsulta.SelectedRows
                    ...
                    registrosSeleccionados(j) = tblconsulta.Item(filaSeleccionada, "CAR_SUNAT") & "|" &
    ...
    Sub AsignarAyuda(ByVal indice As Integer, ByVal tblhelp_p As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        ...
        Try
            ...
            Select Case indice
                Case 0
                    'CONCEPTO
                    tblconsulta(RowIndex, "Concepto") = tblhelp_p.Columns("CO08DESCRIPCION").Value.ToString
                    tblconsulta(RowIndex, "Asiento_Tipo") = tblhelp_p.Columns("CO08ASIENTOTIPOCOD").Value.ToString
                    ...
                    tblconsulta(RowIndex, "Nro_Voucher") = tblhelp_p.Columns("CO08NOMENCLATURA").Value.ToString

                    tblconsulta(RowIndex, "ccc01subd") = tblhelp_p.Columns("ccc03lib").Value.ToString ' Libro
                    tblconsulta(RowIndex, "ccc01deta") = tblhelp_p.Columns("CO08DESCRIPCION").Value.ToString ' Concepto
    ...
    Sub AsignarAyudaText(ByVal indice As Integer, ByVal tblhelp_p As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        ...
        Try
            ...
            Select Case indice
                Case 0
                    'CONCEPTO
                    txtConcepto.Text = tblhelp1_bloque.Columns("CO08DESCRIPCION").Value.ToString
                    txtAsientoCod.Text = tblhelp1_bloque.Columns("CO08ASIENTOTIPOCOD").Value.ToString
                    ...
                    txtNomenclatura.Text = tblhelp1_bloque.Columns("CO08NOMENCLATURA").Value.ToString
    ...
    Private Sub tblconsulta_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tblconsulta.KeyDown
        ...
        Try
            ...
            If e.KeyCode = Keys.F1 Then
                If ColIndex = 27 Then ' si es centro costo
                    TraerAyudaVisible(1, "", btnsalir)

                ElseIf ColIndex = 28 Then ' si es asiento tipo
            ...
            If e.KeyCode = Keys.Enter Then
                If ColIndex = 31 Then
                    ...
                    a = objSql.Ejecutar2("Sp_Con_Traer_NroVoucher", gbcodempresa, gbano, gbmes, tblconsulta.Item(RowIndex, "Libro").ToString(), Nomenclatura, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            a = objSql.Ejecutar2("Sp_Con_Traer_NroVoucher", gbcodempresa, gbano, gbmes, txtLibro.Text.ToString(), txtNomenclatura.Text, "")
            NuevoNroVoucher = a(1, 1)
    ...
    Private Sub tblconsulta_ButtonClick(ByVal sender As System.Object, ByVal e As C1.Win.C1TrueDBGrid.ColEventArgs) Handles tblconsulta.ButtonClick
        ...
        Try
            ...
            colIndex = tblconsulta.Col
            NuevoNroVoucher = ""
            If colIndex = 32 Then ' REFRESCAR NRO VOUCHER
                libro = tblconsulta.Item(rowIndex, "Libro").ToString()
                Nomenclatura = tblconsulta.Item(rowIndex, "Nro_voucher").ToString().ToUpper()
                a = objSql.Ejecutar2("Sp_Con_Traer_NroVoucher", gbcodempresa, gbano, gbmes, libro, Nomenclatura, "")
                NuevoNroVoucher = a(1, 1)
                tblconsulta(rowIndex, "Nro_voucher") = NuevoNroVoucher
                tblconsulta(rowIndex, "ccc01numer") = NuevoNroVoucher

            ElseIf colIndex = 34 Then ' PREVISUALIZAR
            ...
            ElseIf colIndex = 33 Then ' INSERTAR VOUCHER
    ...
    Private Sub Frm_RegistrarVentas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            tblconsulta.Splits(1).DisplayColumns(28).Style.BackColor = Color.SandyBrown
    ...
    Private Sub tblhelp1_bloque_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tblhelp1_bloque.KeyDown
        Try
            If e.KeyCode = Keys.Enter Then
                tblhelp1_bloque_DoubleClick(Nothing, Nothing)
            ElseIf e.KeyCode = Keys.Escape Then
                If tblhelp1_bloque.Visible = True Then
                    tblhelp1_bloque.Visible = False
                End If
