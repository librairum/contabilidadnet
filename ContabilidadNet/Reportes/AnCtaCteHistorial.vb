...
Public Class AnCtaCteHistorial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.AnCtaCteHistorial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAnCtaCteHistorial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnCtaCteHistorial = New AnCtaCteHistorial()
        rpt.Site = Me.Site
        Return rpt
    End Function
