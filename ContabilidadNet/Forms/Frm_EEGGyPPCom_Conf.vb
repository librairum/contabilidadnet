...
Option Explicit On
Option Strict On
Public Class Frm_EEGGyPPCom_Conf
...
#End Region
    ...
    Sub eliminar()
        ...
        Try
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_cc01estructEGyPComp", gbcodempresa, Tiporeporte, gbano, correlativo, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc01estructEGyPComp", gbcodempresa, Tiporeporte, gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text.Trim, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cc01estructEGyPComp", gbcodempresa, Tiporeporte, gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text.Trim, "")
                ' Asigno los Valores a los Parametros del Query
            ElseIf accionMante = "I" Then
                a = objSql.Ejecutar2("Spu_Con_Inserta_cc01estructEGyPComp", gbcodempresa, Tiporeporte, gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text, "")
                ' Asigno los Valores a los Parametros del Query
            Else
