Option Explicit On
Option Strict On
Public Class Frm_Motivo_Ventas
...
#Region "Metodos de Mantenimiento"
    ...
    Public Sub CrearColumnas()
        ...
        Try
            ...
            dt.Columns.Add("co08ITEM", GetType(String))
            dt.Columns.Add("co08DESCRIPCION", GetType(String))
            dt.Columns.Add("co08ASIENTOTIPOCOD", GetType(String))
            dt.Columns.Add("ccc03des", GetType(String))
            dt.Columns.Add("co08NOMENCLATURA", GetType(String))
    ...
    Sub cargarDatos()
        Try
            ...
            Vista = objSql.TraerDataTable("Spu_Con_Trae_co08MotivosDocPorPagar_Ventas", gbcodempresa, gbano).DefaultView
...
#End Region
    ...
    Private Sub btncancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btncancelar.Click
        Frm_Motivo_Ventas_Load(Nothing, Nothing)
    ...
    Private Sub Frm_Motivo_Ventas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Sub cargarFila(ByVal filaactiva As DataRowView)
        ...
        Try
            ...
            If Not filaactiva Is Nothing Then
                txtCodigo.Text = tblconsulta.Item(tblconsulta.Row, "co08ITEM").ToString().Trim()
                txtDescri.Text = tblconsulta.Item(tblconsulta.Row, "CO08DESCRIPCION").ToString().Trim()
                txtAsientoTipoCod.Text = tblconsulta.Item(tblconsulta.Row, "CO08ASIENTOTIPOCOD").ToString().Trim()
                txtNomenclatura.Text = tblconsulta.Item(tblconsulta.Row, "CO08NOMENCLATURA").ToString().Trim()
    ...
    Sub eliminar()
        ...
        Try
            ...
            'CodigoActivoAnt = FilaDeTablaAnterior("co10ITEM").ToString
            'CodigoActivo = FilaDeTabla("co10ITEM").ToString
            ''
            Beep()
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_co08MotivosDocPorPagar_Ventas", gbcodempresa, txtDescri.Text.ToString.Trim(), ITEM, msgretorno)
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_co08MotivosDocPorPagar_Ventas", gbcodempresa, txtDescri.Text.ToString.ToString().Trim(), txtAsientoTipoCod.Text.ToString().Trim(), txtNomenclatura.Text.ToString.Trim(), MsgRetorno)
            ElseIf accionMante = "M" Then
                Dim ITEM = Convert.ToInt32(txtCodigo.Text.ToString())
                a = objSql.Ejecutar2("Spu_Con_Upd_co08MotivosDocPorPagar_Ventas", gbcodempresa, txtDescri.Text.ToString.ToString().Trim(), ITEM, txtAsientoTipoCod.Text.ToString().Trim(), txtNomenclatura.Text.ToString().Trim(), MsgRetorno)
                ' Asigno los Valores a los Parametros del Query
            Else
