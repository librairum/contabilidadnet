...
Public Class Rpt_libInvbal49
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_libInvbal49.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_libInvbal49
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_libInvbal49 = New Rpt_libInvbal49()
        rpt.Site = Me.Site
        Return rpt
    End Function
