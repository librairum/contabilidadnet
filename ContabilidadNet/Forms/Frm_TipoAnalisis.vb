...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub TraeTipoAnalisis()
        Try
            Vista = objSql.TraerDataTable("sp_Con_Trae_Tipos_Analisis", gbcodempresa, "ccb17cdgo ASC").DefaultView
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                txtCodigo.Text = filaactiva("ccb17cdgo").ToString
                txtDescri.Text = filaactiva("ccb17desc").ToString
            End If
        Catch ex As Exception
...
#End Region
    ...
    Sub eliminar()
        ...
        Try
            ...
            CodigoActivoAnt = FilaDeTablaAnterior("ccb17cdgo").ToString
            CodigoActivo = FilaDeTabla("ccb17cdgo").ToString
            '
            Beep()
            ...
            a = objSql.Ejecutar2("sp_Con_Del_Tipo_Analisis", gbcodempresa, txtCodigo.Text.Trim, "")

            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("ccb17cdgo", txtCodigo.Text.Trim, tblconsulta, Vista)
            Else
                'No hago nada
            End If
        Catch ex As Exception
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("sp_Con_Ins_Tipo_Analisis", gbcodempresa, txtCodigo.Text.Trim, txtDescri.Text.Trim, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("sp_Con_Upd_Tipo_Analisis", gbcodempresa, txtCodigo.Text.Trim, txtDescri.Text.Trim, "")
                ' Asigno los Valores a los Parametros del Query
            Else
