...
Public Class Frm_Regcomprasnroformulario
...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub TraeRegcomprasdatos()
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_cc20RegcomprasDatos", gbcodempresa, gbano).DefaultView
...
#Region "Metodos de Mantenimiento"
    ...
    Sub HabilitarMantenimiento(ByVal valor As Boolean)
        Try
            ...
            txtmes.ReadOnly = If(Me.accionMante = "M", True, Not valor)
        Catch ex As Exception
        End Try
    End Sub
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txtmes.Text = filaactiva("cc20mes").ToString
                txtnroformulario.Text = filaactiva("cc20nroformulario").ToString
                txtnroorden.Text = filaactiva("cc20nroorden").ToString
...
#End Region
    ...
    Private Sub Frm_Regcomprasnroformulario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try

            'Inicializo mi formulario desde donde se cargo 
            Mod_Mantenimiento.formatearformulario(Me)
            Mod_Mantenimiento.Centrar(Me)
            Me.Text = "Datos de Registro de compras"
            '
    ...
    Sub eliminar()
        Try
            ...
            '
            Beep()
            If MessageBox.Show("AVISO :: Esta seguro de Eliminar el REGISTRO : " & txtmes.Text.Trim, "Eliminar Registro", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then Exit Sub
            Me.accionMante = "E"
            ' Asigno los Valores a los Parametros del Query
            Dim a As Array = Array.CreateInstance(GetType(Object), 2, 10)
            a = objSql.Ejecutar2("Spu_Con_Del_cc20RegcomprasDatos", gbcodempresa, gbano, txtmes.text, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If txtmes.Text.Trim.Length <> 2 Then MessageBox.Show(gbc_MensajeValidar + "Mes no valido", "", MessageBoxButtons.OK, MessageBoxIcon.Error) : txtmes.Focus() : Exit Sub
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc20RegcomprasDatos", gbcodempresa, gbano, txtmes.Text.Trim, txtnroformulario.Text.Trim, txtnroorden.Text.Trim, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cc20RegcomprasDatos", gbcodempresa, gbano, txtmes.Text.Trim, txtnroformulario.Text.Trim, txtnroorden.Text.Trim, "")
                ' Asigno los Valores a los Parametros del Query
            Else
