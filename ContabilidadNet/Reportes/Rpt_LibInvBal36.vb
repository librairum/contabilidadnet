...
Public Class Rpt_LibInvBal36
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_LibInvBal36.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_LibInvBal36
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_LibInvBal36 = New Rpt_LibInvBal36()
        rpt.Site = Me.Site
        Return rpt
    End Function
