...
Public Class rpt_MaquinasAnalisis
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_MaquinasAnalisis.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.rpt_MaquinasAnalisis.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ccb01pro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_MaquinasAnalisis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_MaquinasAnalisis = New rpt_MaquinasAnalisis()
        rpt.Site = Me.Site
        Return rpt
    End Function
