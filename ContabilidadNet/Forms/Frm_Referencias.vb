...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub TraeReferencias()
        Try
            Vista = objSql.TraerDataTable("sp_Con_Trae_Referencias", gbcodempresa, "ccb04cod ASC").DefaultView
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                txtCodigo.Text = filaactiva("ccb04cod").ToString
                txtDescri.Text = filaactiva("ccb04des").ToString
            End If
        Catch ex As Exception
...
#End Region
    ...
    Private Sub Frm_Referencias_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Sub eliminar()
        ...
        Try
            ...
            CodigoActivoAnt = FilaDeTablaAnterior("ccb04cod").ToString
            CodigoActivo = FilaDeTabla("ccb04cod").ToString
            '
            Beep()
            ...
            a = objSql.Ejecutar2("sp_Con_Del_Referencia", gbcodempresa, txtCodigo.Text.Trim, "")

            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("ccb04cod", txtCodigo.Text.Trim, tblconsulta, Vista)
            Else
                'No hago nada
            End If
        Catch ex As Exception
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("sp_Con_Ins_Referencia", gbcodempresa, txtCodigo.Text.Trim, txtDescri.Text.Trim, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("sp_Con_Upd_Referencia", gbcodempresa, txtCodigo.Text.Trim, txtDescri.Text.Trim, "")
                ' Asigno los Valores a los Parametros del Query
            Else
