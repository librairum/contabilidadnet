Option Explicit On
Option Strict On
Public Class Frm_tablasGlobales_Abc
#Region "DECLARACIONES"
    ...
    Dim tabla As String
    Dim frmOrigen As Frm_TablasGlobales
    'Variable para 
...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub TraeDetalesdetabla(ByVal Codtabla As String)
        Try
            Vista = objSql.TraerDataTable("Spu_Glo_Trae_glo01tablas_Det", Codtabla, "glo01codigo", "*").DefaultView
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                txtCodigo.Text = filaactiva("glo01codigo").ToString
                txtDescri.Text = filaactiva("glo01descripcion").ToString
                txttexto.Text = filaactiva("glo01texto1").ToString
                txtcomentario.Text = filaactiva("glocomentario").ToString
...
#End Region
    ...
    Private Sub Frm_tablasGlobales_Abc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            'Inicializo mi formulario desde donde se cargo 
            Mod_Mantenimiento.formatearformulario(Me)
            Mod_Mantenimiento.Centrar(Me)
            Me.Text = "Detalle de tablas globales"
            '
            ...
            frmOrigen = CType(Me.Owner, Frm_TablasGlobales)
            tabla = frmOrigen.P_FilaDeTabla("glo01codigotabla").ToString
            Me.TraeDetalesdetabla(tabla)
    ...
    Sub eliminar()
        ...
        Try
            ...
            CodigoActivoAnt = FilaDeTablaAnterior("glo01codigo").ToString
            CodigoActivo = FilaDeTabla("glo01codigo").ToString
            '
            Beep()
            ...
            a = objSql.Ejecutar2("Spu_Glo_Del_glo01tablas", tabla, txtCodigo.Text.Trim, "")

            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("glo01codigo", CodigoActivoAnt, tblconsulta, Vista)
            Else
                'No hago nada
            End If
        Catch ex As Exception
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Glo_Ins_glo01tablas", tabla, txtCodigo.Text.Trim, txtDescri.Text.Trim, txttexto.Text.Trim, txtcomentario.Text.Trim, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Glo_Upd_glo01tablas", tabla, txtCodigo.Text.Trim, txtDescri.Text.Trim, txttexto.Text.Trim, txtcomentario.Text.Trim, "")
                ' Asigno los Valores a los Parametros del Query
            Else
            ...
            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("glo01codigo", txtCodigo.Text.Trim, tblconsulta, Vista)
                Me.HabilitarMantenimiento(False)
            Else
                'No hago nada
            End If
