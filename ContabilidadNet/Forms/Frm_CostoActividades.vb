...
Option Explicit On
Option Strict On
Public Class Frm_CostoActividades
...
#Region "Mantenimiento"
    ...
    Sub AsignarAyuda(ByVal indice As Integer, ByVal tblhelp_p As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        Try
            Select Case indice
                Case 0
                    txtcodsubproceso.Text = tblhelp_p.Columns("cctcodigo").Value.ToString
                    lblhelp_0.Text = tblhelp_p.Columns("cctdescripcion").Value.ToString
                    txtcodsubproceso.Focus()
            End Select
    ...
    Sub TraeDameDescripcion(ByVal indice As Integer)
        Try
            Select Case indice
                Case 0
                    If txtcodsubproceso.Text = "" Then
                        lblhelp_0.Text = ""
                    Else
                        lblhelp_0.Text = Mod_BaseDatos.DameDescripcion(gbano + txtcodsubproceso.Text.Trim, "TIPGAS")
                    End If
            End Select
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txtcodsubproceso.Text = filaactiva("ccgcodtipgasto").ToString
...
#End Region
    ...
    Private Sub Frm_CostoSubproceso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Me.Text = "Maestro de actividades"
            '
    ...
    Sub eliminar()
        ...
        Try
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_ccggasto", gbcodempresa, gbano, txtcodsubproceso.Text, txtCodigo.Text.Trim, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If lblhelp_0.Text = "" Or lblhelp_0.Text = "???" Then Beep() : MessageBox.Show("Libro de compras no valido", "", MessageBoxButtons.OK, MessageBoxIcon.Error) : txtcodsubproceso.Focus() : Exit Sub
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_ccggasto", gbcodempresa, gbano, txtcodsubproceso.Text, txtCodigo.Text.Trim, txtDescri.Text.Trim, "", "", "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_ccggasto", gbcodempresa, gbano, txtcodsubproceso.Text, txtCodigo.Text.Trim, txtDescri.Text.Trim, "", "", "")
                ' Asigno los Valores a los Parametros del Query
            Else
            ...
            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("identificador", txtcodsubproceso.Text.Trim + txtCodigo.Text.Trim, tblconsulta, Vista)
                Me.HabilitarMantenimiento(False)
            Else
                'No hago nada
            End If
    ...
    Private Sub txtcodtipgasto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtcodsubproceso.KeyDown
        Me.btnhelp_0_Click(Nothing, Nothing)
    End Sub

    Private Sub txtcodtipgasto_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtcodsubproceso.LostFocus
        Me.TraeDameDescripcion(0)
    End Sub

    Private Sub txtcodtipgasto_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtcodsubproceso.TextChanged
