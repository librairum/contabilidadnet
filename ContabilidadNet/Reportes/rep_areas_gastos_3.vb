...
Public Class rep_areas_gastos_3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.rep_areas_gastos_3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_areas_gastos_3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_areas_gastos_3 = New rep_areas_gastos_3()
        rpt.Site = Me.Site
        Return rpt
    End Function
