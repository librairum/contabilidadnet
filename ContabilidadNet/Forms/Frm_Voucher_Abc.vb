...
#Region "DECLARACIONES"
    ...
    Dim frmOrigen As Frm_Voucher
    ' Dim frmOrigen As Object
    Dim frmOrigen2 As Frm_RegistrarCompras
...
#Region "Metodos de Mantenimiento"
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        ...
        End Try
    End Sub
    Sub cargarDatos2(ByVal filaactiva As DataRowView)
        Try
            If filaactiva Is Nothing Then Exit Sub
            If Not filaactiva Is Nothing Then
                txtlibro.Text = filaactiva("Libro").ToString ' libro
                TraeDameDescripcion(0)
                txtNoVoucher.Text = filaactiva("Nro_voucher").ToString ' Voucher
                mskfecha.Text = filaactiva("Fecha_emision").ToString ' Fecha
                txtDescri.Text = filaactiva("Concepto").ToString ' Concepto
                Me.CargaDetalleVoucher()
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "ERROR :: Al enlazar datos", MessageBoxButtons.OK, MessageBoxIcon.Information)
...
#End Region
    ...
    Private Sub Frm_Voucher_Abc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Dim frmOption As Object
         
                If Me.Owner IsNot Nothing AndAlso TypeOf Me.Owner Is Frm_Voucher Then
                frmOrigen = CType(Me.Owner, Frm_Voucher)
            Else
                ' NO HAGAS NADA
            End If
            ...
            ElseIf Me.accionMante = "V" Then
                'If TypeOf frmOrigen Is Frm_Voucher Then
                Me.cargarDatos(RegistroActivo)
                Me.HabilitarMantenimiento(False)
                'End If
                'Else
    ...
    Private Sub tblhelp_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles tblhelp.DoubleClick
        Try
            ...
            Select Case CType(tblhelp.Tag, Integer)
                Case 0
