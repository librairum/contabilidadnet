...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub TraeTipoGastos(ByVal campo As String, ByVal filtro As String)
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_cctipgasto", gbcodempresa, gbano, campo, filtro).DefaultView
...
#Region "Mantenimiento"
    ...
    Sub AsignarAyuda(ByVal indice As Integer, ByVal tblhelp_p As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        Try
            Select Case indice
                Case 0
                    txttipocosto.Text = tblhelp_p.Columns("glo01codigo").Value.ToString
                    lblhelp_0.Text = tblhelp_p.Columns("glo01descripcion").Value.ToString
                    txttipocosto.Focus()
            End Select
    ...
    Sub TraeDameDescripcion(ByVal indice As Integer)
        Try
            Select Case indice
                Case 0
                    If txttipocosto.Text = "" Then
                        lblhelp_0.Text = ""
                    Else
                        lblhelp_0.Text = Mod_BaseDatos.DameDescripcion("47" & txttipocosto.Text.Trim, "GL")
                    End If
            End Select
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                txtCodigo.Text = filaactiva("cctcodigo").ToString
                txtDescri.Text = filaactiva("cctdescripcion").ToString
                txttipocosto.Text = filaactiva("ccttipocosto").ToString
            End If
        Catch ex As Exception
...
#End Region
    ...
    Sub eliminar()
        ...
        Try
            ...
            CodigoActivoAnt = FilaDeTablaAnterior("cctcodigo").ToString
            CodigoActivo = FilaDeTabla("cctcodigo").ToString
            '
            Beep()
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_cctipgasto", gbcodempresa, gbano, txtCodigo.Text.Trim, "")

            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("cctcodigo", CodigoActivoAnt, tblconsulta, Vista)
            Else
                'No hago nada
            End If
        Catch ex As Exception
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cctipgasto", gbcodempresa, gbano, txtCodigo.Text.Trim, txtDescri.Text.Trim, txttipocosto.Text.Trim, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cctipgasto", gbcodempresa, gbano, txtCodigo.Text.Trim, txtDescri.Text.Trim, txttipocosto.Text.Trim, "")
                ' Asigno los Valores a los Parametros del Query
            Else
            ...
            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("cctcodigo", txtCodigo.Text.Trim, tblconsulta, Vista)
                Me.HabilitarMantenimiento(False)
            Else
                'No hago nada
            End If
