...
Public Class Frm_LibLeg_101RegistroCosto
...
#Region "Metodos de Mantenimiento"
    ...
    Sub cargarDatos()
        Try
            ...
            Vista = objSql.TraerDataTable("Spu_Con_Trae_lc101RegCosEstCosto", gbcodempresa, gbano).DefaultView
            tblconsulta.SetDataBinding(Vista, Nothing, True)
            Me.capturarfilaactual()
        Catch ex As Exception
...
#End Region
    ...
    Private Sub Frm_LibLeg_101RegistroCosto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Sub cargarFila(ByVal filaactiva As DataRowView)
        ...
        Try
            ...
            If Not filaactiva Is Nothing Then
                txtCodigo.Text = tblconsulta.Item(tblconsulta.Row, "lc101Correlativo").ToString().Trim()
                txtDescri.Text = tblconsulta.Item(tblconsulta.Row, "lc101Descripcion").ToString().Trim()
                ...
                txtCuentaContable.Text = tblconsulta.Item(tblconsulta.Row, "lc101CtaCble").ToString.Trim
                txtImporte.Text = CType(tblconsulta.Item(tblconsulta.Row, "lc101Importe"), Double).ToString
    ...
    Private Sub tblconsulta_RowColChange(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.RowColChangeEventArgs) Handles tblconsulta.RowColChange
        Try
            ...
            End If
            txtCuentaContable.Text = tblconsulta.Item(tblconsulta.Row, "lc101CtaCble").ToString().Trim()
            txtImporte.Text = tblconsulta.Item(tblconsulta.Row, "lc101Importe").ToString().Trim()
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_lc101RegCosEstCosto", gbcodempresa, gbano, txtDescri.Text.ToString.Trim, txtCuentaContable.Text.ToString.Trim, txtImporte.Text.ToString.Trim, "")
            ElseIf accionMante = "M" Then
                Dim ITEM = Convert.ToInt32(txtCodigo.Text.ToString())
                a = objSql.Ejecutar2("Spu_Con_Upd_lc101RegCosEstCosto", gbcodempresa, gbano, txtCodigo.Text.ToString.Trim, txtCuentaContable.Text.ToString.Trim, txtImporte.Text.ToString.Trim, "")
            Else
        ...
        Try
            ...
            Select Case index
                ...
                Case 3
                    ...
                    tblhelp_0.Columns(1).DataField = "lc101Anio"
                    Me.Traeimportacion()
                    tblhelp_0.Visible = True
                    tblhelp_0.Focus()
    ...
    Sub AsignarAyuda(ByVal indice As Integer, ByVal tblhelp_p As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        ...
        Try
            ...
            Select Case indice
                ...
                Case 2
                    'ASIENTO TIPO
                    txtCuentaContable.Text = tblhelp_p.Columns("Codigo").Value.ToString()
                ...
                Case 3
                    ...
                    If MessageBox.Show("¿Esta Seguro de importar datos del año : " & anioanterior, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        Cursor.Current = Cursors.WaitCursor
                        Frm_LibLeg_101RegistroCosto_Load(Nothing, Nothing)
                        a = objSql.Ejecutar2("Spu_Con_Ins_PerAntlc101RegCosEstCosto", gbcodempresa, gbano, anioanterior, "")
                        If Funciones.Funciones.MensajesdelSQl(a) = True Then
                            tblconsulta.DataSource = ""
                            Frm_LibLeg_101RegistroCosto_Load(Nothing, Nothing)
    ...
    Private Sub Traeimportacion()
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_lc101RegCosEstCostoxanio", gbcodempresa).DefaultView
