...
Public Class Rpt_EstCamPatNeto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_EstCamPatNeto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cc01Mes() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_EstCamPatNeto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_EstCamPatNeto = New Rpt_EstCamPatNeto()
        rpt.Site = Me.Site
        Return rpt
    End Function
