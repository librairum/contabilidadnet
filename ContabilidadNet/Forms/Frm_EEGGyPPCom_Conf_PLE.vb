...
Option Explicit On
Option Strict On
Public Class Frm_EEGGyPPCom_Conf_PLE
...
#End Region
    ...
    Private Sub Frm_EEGGyPPCom_Conf_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            '
            Me.Text = "Configurar Estados Financieros"
            '
    ...
    Sub eliminar()
        ...
        Try
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_cc01estructEGyPComp_PLE", gbcodempresa, Tiporeporte, gbano, correlativo, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc01estructEGyPComp_PLE", gbcodempresa, Tiporeporte, gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text.Trim, txtCodPLE.Text, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cc01estructEGyPComp_PLE", gbcodempresa, Tiporeporte, gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text.Trim, txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            ElseIf accionMante = "I" Then
                a = objSql.Ejecutar2("Spu_Con_Inserta_cc01estructEGyPComp_PLE", gbcodempresa, Tiporeporte, gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text, txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            Else
