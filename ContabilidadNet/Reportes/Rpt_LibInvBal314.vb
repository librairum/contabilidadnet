...
Public Class Rpt_LibInvBal314
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_LibInvBal314.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_LibInvBal314
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_LibInvBal314 = New Rpt_LibInvBal314()
        rpt.Site = Me.Site
        Return rpt
    End Function
