...
Public Class Rpt_BalGenLegal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_BalGenLegal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_BalGenLegal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_BalGenLegal = New Rpt_BalGenLegal()
        rpt.Site = Me.Site
        Return rpt
    End Function
