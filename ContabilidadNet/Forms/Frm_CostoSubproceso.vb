Option Explicit On
Option Strict On
Public Class Frm_CostoSubproceso
...
#Region "Mantenimiento"
    ...
    Sub AsignarAyuda(ByVal indice As Integer, ByVal tblhelp_p As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        Try
            Select Case indice
                Case 0
                    txtproceso.Text = tblhelp_p.Columns("cctcodigo").Value.ToString
    ...
    Sub TraeDameDescripcion(ByVal indice As Integer)
        Try
            Select Case indice
                Case 0
                    If txtproceso.Text = "" Then
                        lblhelp_0.Text = ""
                    Else
                        lblhelp_0.Text = Mod_BaseDatos.DameDescripcion(gbano + txtproceso.Text.Trim, "TIPGAS")
                    End If
            End Select
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txtproceso.Text = filaactiva("ccgcodtipgasto").ToString
...
#End Region
    ...
    Private Sub Frm_CostoSubproceso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try

            'Inicializo mi formulario desde donde se cargo 
            Mod_Mantenimiento.formatearformulario(Me)
            Mod_Mantenimiento.Centrar(Me)
            Me.Text = "Maestro de sub procesos"
            '
    ...
    Sub eliminar()
        ...
        Try
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_ccggasto", gbcodempresa, gbano, txtproceso.Text, txtCodigo.Text.Trim, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If lblhelp_0.Text = "" Or lblhelp_0.Text = "???" Then Beep() : MessageBox.Show("Libro de compras no valido", "", MessageBoxButtons.OK, MessageBoxIcon.Error) : txtproceso.Focus() : Exit Sub
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_ccggasto", gbcodempresa, gbano, txtproceso.Text, txtCodigo.Text.Trim, txtDescri.Text.Trim, "", "", "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_ccggasto", gbcodempresa, gbano, txtproceso.Text, txtCodigo.Text.Trim, txtDescri.Text.Trim, "", "", "")
                ' Asigno los Valores a los Parametros del Query
            Else
            ...
            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("identificador", txtproceso.Text.Trim + txtCodigo.Text.Trim, tblconsulta, Vista)
                Me.HabilitarMantenimiento(False)
            Else
                'No hago nada
            End If
    ...
    Private Sub txtcodtipgasto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtproceso.KeyDown
        Me.btnhelp_0_Click(Nothing, Nothing)
    End Sub

    Private Sub txtcodtipgasto_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtproceso.LostFocus
        Me.TraeDameDescripcion(0)
    End Sub

    Private Sub txtcodtipgasto_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtproceso.TextChanged
