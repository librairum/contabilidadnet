    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                txtCodigo.Text = filaactiva("cc25codigo").ToString
                txtDescri.Text = filaactiva("cc25descripcion").ToString
            End If
        Catch ex As Exception
...
#End Region
    ...
    Private Sub Frm_TrabEnCurso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try

            'Inicializo mi formulario desde donde se cargo 
            Mod_Mantenimiento.formatearformulario(Me)
            Mod_Mantenimiento.Centrar(Me)
            Me.Text = "Maestro de Trabajos en Curso"
            '
    ...
    Sub eliminar()
        ...
        Try
            ...
            CodigoActivoAnt = FilaDeTablaAnterior("cc25codigo").ToString
            CodigoActivo = FilaDeTabla("cc25codigo").ToString
            '
            Beep()
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_cc25trabajosencurso", gbcodempresa, gbano, txtCodigo.Text.Trim, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc25trabajosencurso", gbcodempresa, gbano, txtCodigo.Text.Trim, txtDescri.Text.Trim, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Inv_Upd_cc25trabajosencurso", gbcodempresa, gbano, txtCodigo.Text.Trim, txtDescri.Text.Trim, "")
                ' Asigno los Valores a los Parametros del Query
            Else
