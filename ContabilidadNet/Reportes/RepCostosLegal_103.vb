...
Public Class RepCostosLegal_103
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.RepCostosLegal_103.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepCostosLegal_103
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepCostosLegal_103 = New RepCostosLegal_103()
        rpt.Site = Me.Site
        Return rpt
    End Function
