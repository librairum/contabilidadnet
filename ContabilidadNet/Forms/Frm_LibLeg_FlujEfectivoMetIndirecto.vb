...
Option Explicit On
Option Strict On
Public Class Frm_LibLeg_FlujEfectivoMetIndirecto
...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub Traeimportacion()
        Try
            vistahelp = objSql.TraerDataTable("Spu_Con_Trae_Percc01estructFlujEfect_MetodIndirec", gbcodempresa).DefaultView
    ...
    Sub TraeEstructura()
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_cc01estructFlujEfect_MetodIndirec", gbcodempresa, gbano, gbmes).DefaultView
            ...
            Select Case indice
                Case 0
                    If txttipofila.Text = "" Then
                        lblhelp_0.Text = ""
                    Else
                        lblhelp_0.Text = Mod_BaseDatos.DameDescripcion("38" + txttipofila.Text, "GL")
                    End If
                Case 1
                    If txtfuente.Text = "" Then
                        lblhelp_1.Text = ""
                    Else
                        lblhelp_1.Text = Mod_BaseDatos.DameDescripcion("40" + txtfuente.Text, "GL")
                    End If
                Case 2
                    If txtgrupo.Text = "" Then
                        lblhelp_2.Text = ""
                    Else
                        lblhelp_2.Text = Mod_BaseDatos.DameDescripcion("39" + txtgrupo.Text, "GL")
                    End If
                Case 3
                    If txtsubgrupo.Text = "" Then
                        lblhelp_3.Text = ""
                    Else
                        lblhelp_3.Text = Mod_BaseDatos.DameDescripcion("41" + txtsubgrupo.Text, "GL")
                    End If
        ...
        Try
            ...
            Select Case index
                Case 0
                    ...
                    Me.TraeTablasGloables("38")
                Case 1
                    tblhelp.Columns(0).DataField = "glo01codigo"
                    tblhelp.Columns(1).DataField = "glo01descripcion"
                    Me.TraeTablasGloables("40")
                Case 2
                    tblhelp.Columns(0).DataField = "glo01codigo"
                    tblhelp.Columns(1).DataField = "glo01descripcion"
                    Me.TraeTablasGloables("39")
                Case 3
                    tblhelp.Columns(0).DataField = "glo01codigo"
                    tblhelp.Columns(1).DataField = "glo01descripcion"
                    Me.TraeTablasGloables("41")
                Case 4 'Importar
            ...
            Select Case indice
                ...
                Case 4
                    ...
                    If MessageBox.Show("¿Esta Seguro de importar datos del año : " & anioanterior, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        a = objSql.Ejecutar2("Spu_Con_Ins_Percc01estructFlujEfect_MetodIndirec", gbcodempresa, gbano, gbmes, anioanterior, mesanterior, "")
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txtfuente.Text = filaactiva("cc01signo").ToString
                ...
                txtCodPLE.Text = filaactiva("cc01codigoPLE").ToString
...
#End Region
    ...
    Private Sub Frm_LibLeg_Balgen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.Text = Frm_LibrosLegales.rbtrepauxiliares_25.Text
            '
    ...
    Sub eliminar()
        ...
        Try
            ...
            Dim a As Array = Array.CreateInstance(GetType(Object), 2, 10)
            a = objSql.Ejecutar2("Spu_Con_Del_cc01estructFlujEfect_MetodIndirec", gbcodempresa, gbano, gbmes, correlativo, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If txtSaldo.Text = "" Then
                txtSaldo.Text = CStr(0)
            End If
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc01estructFlujEfect_MetodIndirec", gbcodempresa, gbano, gbmes, correlativo, grupo, tipofila, fuente, subgrupo, txtdescripcion.Text, txtSaldo.Text.Trim, txtCodPLE.Text, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cc01estructFlujEfect_MetodIndirec", gbcodempresa, gbano, gbmes, correlativo, grupo, tipofila, fuente, subgrupo, txtdescripcion.Text, txtSaldo.Text.Trim, txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            ElseIf accionMante = "I" Then
                a = objSql.Ejecutar2("Spu_Con_Inserta_cc01estructFlujEfect_MetodIndirec", gbcodempresa, gbano, gbmes, correlativo, grupo, tipofila, fuente, subgrupo, txtdescripcion.Text, txtSaldo.Text.Trim, txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            Else
