...
Public Class Rep_Lc50capital
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rep_Lc50capital.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_lc50Empresa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRep_Lc50capital
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_Lc50capital = New Rep_Lc50capital()
        rpt.Site = Me.Site
        Return rpt
    End Function
