...
Public Class RptRegCompraAnual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.RptRegCompraAnual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRegCompraAnual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRegCompraAnual = New RptRegCompraAnual()
        rpt.Site = Me.Site
        Return rpt
    End Function
