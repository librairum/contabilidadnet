Option Explicit On
Option Strict On
Public Class Frm_BuenosAportadores
...
#Region "Base de Datos"
    Private Sub TraeBuenosAportadores()
        Try
            Vista = objSql.TraerDataTable("sp_Con_Trae_BuenosAportadores", "RUC", "*").DefaultView
...
#End Region
    Private Sub Frm_Distribucion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Me.Text = "Buenos Aportadores"
            '
            Me.TraeBuenosAportadores()
    ...
    Sub imprimir(ByVal flagimpresion As String)
        ...
        Try
            ...
            '========================================
            nombredereporte = "BuenAport.Rpt"
            'Sp que trae datos del reporte
            ds = objSql.TraerDataSet("sp_Con_Trae_BuenosAportadores", "RUC", "*").Copy()
            '
