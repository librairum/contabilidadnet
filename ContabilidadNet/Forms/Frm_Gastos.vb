...
#Region "Mantenimiento"
    ...
    Sub AsignarAyuda(ByVal indice As Integer, ByVal tblhelp_p As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        Try
            Select Case indice
                Case 0
                    txtcodtipgasto.Text = tblhelp_p.Columns("cctcodigo").Value.ToString
                    lblhelp_0.Text = tblhelp_p.Columns("cctdescripcion").Value.ToString
                    txtcodtipgasto.Focus()
            End Select
    ...
    Sub TraeDameDescripcion(ByVal indice As Integer)
        Try
            Select Case indice
                Case 0
                    If txtcodtipgasto.Text = "" Then
                        lblhelp_0.Text = ""
                    Else
                        lblhelp_0.Text = Mod_BaseDatos.DameDescripcion(gbano + txtcodtipgasto.Text.Trim, "TIPGAS")
                    End If
            End Select
...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub TraeGastos(ByVal campo As String, ByVal filtro As String)
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_Gasto", gbcodempresa, gbano, campo, filtro).DefaultView
        ...
        End Try
    End Sub
    Sub TraeTipoGastos(ByVal campo As String, ByVal filtro As String)
        Try
            VistaHelp = objSql.TraerDataTable("Spu_Con_Trae_cctipgasto", gbcodempresa, gbano, campo, filtro).DefaultView
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txtcodtipgasto.Text = filaactiva("ccgcodtipgasto").ToString
                Me.TraeDameDescripcion(0)
                txtCodigo.Text = filaactiva("ccgcodigo").ToString
                txtDescri.Text = filaactiva("ccgdescripcion").ToString
...
#End Region
    ...
    Private Sub Frm_TipodeGasto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try

            'Inicializo mi formulario desde donde se cargo 
            Mod_Mantenimiento.formatearformulario(Me)
            Mod_Mantenimiento.Centrar(Me)
            Me.Text = "Maestro de referencias"
            '
    ...
    Sub eliminar()
        ...
        Try
            ...
            CodigoActivoAnt = FilaDeTablaAnterior("identificador").ToString
            CodigoActivo = FilaDeTabla("identificador").ToString
            '
            Beep()
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_ccggasto", gbcodempresa, gbano, txtcodtipgasto.Text, txtCodigo.Text.Trim, "")

            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrillaConFiltro()
                Me.Posicionar("identificador", CodigoActivoAnt, tblconsulta, Vista)
            Else
                'No hago nada
            End If
        Catch ex As Exception
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If lblhelp_0.Text = "" Or lblhelp_0.Text = "???" Then Beep() : MessageBox.Show("Libro de compras no valido", "", MessageBoxButtons.OK, MessageBoxIcon.Error) : txtcodtipgasto.Focus() : Exit Sub
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_ccggasto", gbcodempresa, gbano, txtcodtipgasto.Text, txtCodigo.Text.Trim, txtDescri.Text.Trim, "", "", "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_ccggasto", gbcodempresa, gbano, txtcodtipgasto.Text, txtCodigo.Text.Trim, txtDescri.Text.Trim, "", "", "")
                ' Asigno los Valores a los Parametros del Query
            Else
            ...
            If Funciones.Funciones.MensajesdelSQl(a) = True Then
                Me.refrescarGrilla()
                Me.Posicionar("identificador", txtcodtipgasto.Text.Trim + txtCodigo.Text.Trim, tblconsulta, Vista)
                Me.HabilitarMantenimiento(False)
            Else
                'No hago nada
            End If
    ...
    Private Sub txtcodtipgasto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtcodtipgasto.KeyDown
        Me.btnhelp_0_Click(Nothing, Nothing)
    End Sub

    Private Sub txtcodtipgasto_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtcodtipgasto.LostFocus
        Me.TraeDameDescripcion(0)
    End Sub

    Private Sub txtcodtipgasto_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtcodtipgasto.TextChanged
