...
Public Class Rpt_LibInvBal313
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_LibInvBal313.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_LibInvBal313
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_LibInvBal313 = New Rpt_LibInvBal313()
        rpt.Site = Me.Site
        Return rpt
    End Function
