...
#Region "DECLARACIONES"
    ...
    Dim uv_DocModTipo As String
    Dim uv_DocModNumero As String
    Dim uv_DocModFecha As String
...
#Region "Metodos de Mantenimiento"
    Sub Nuevo()
        ...
        'Valores por defecto
        cbomoneda.Text = "S" ' Por defecto la moneda es soles
    ...
    Sub modificar()
        ...
        End Try
    End Sub
    Sub inhabilitaDocModifica()
        GboxDocMod.Enabled = False
    End Sub
    ...
    End Sub
    Sub habilitaDocModifica(ByVal xlibro As String, ByVal tipodoc As String)
        Dim xTDRet As String
        Try
            'Todo lo inhabilito
            Me.inhabilitarretencion()
            'Si cumple que es del libro  de compras o ventas
            If xlibro = "C" Or xlibro = "V" Then
    ...
    Sub TraerAyuda(ByVal index As Integer, ByVal boton As Button)
        ...
        Try
            ...
            Select Case index
                ...
                Case 5
                    tblhelp.Columns(0).DataField = "ccb13tipdoc"
                    tblhelp.Columns(1).DataField = "ccb13ndoc"
                    Me.trae_documentos_pendientes(txtCuenta.Text, txtCtaCte.Text, mskFecDoc.Text)
                Case 6
                    tblhelp.Columns(0).DataField = "ccm01cta"
                    tblhelp.Columns(1).DataField = "ccm01des"
        ...
        Try
            Select Case indice
                ...
                Case 4
                    ...
                    txtNoDoc.Focus()
                Case 5
                    txtNoDoc.Text = tblhelp.Columns("ccb13tipdoc").Value.ToString
                    lblhelp_5.Text = tblhelp.Columns("ccb13ndoc").Value.ToString
                    mskFecDoc.Focus()
                Case 6
...
#End Region
    ...
    Sub capturavaloresanteriores()
        ...
        '
        uv_DocModTipo = txtdocmodtip.Text
        uv_DocModNumero = txtdocmodNum.Text
        uv_DocModFecha = MskdocmodFecha.Text
        '
    ...
    Sub AsignavaloresAnterior()
        ...
        '
        txtdocmodtip.Text = uv_DocModTipo
        txtdocmodNum.Text = uv_DocModNumero
        MskdocmodFecha.Text = uv_DocModFecha
    ...
    Private Function ValidaIngreso() As Boolean
        ...
        Try
            ...
            'Si muestra cuenta corriente debe exigir tupo y numero de documento
    ...
    Private Sub Frm_VoucherAT_Abc_Det_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '
            ...
            frmOrigen = CType(Me.Owner, Frm_VoucherAT_abc)

            HabilitarMantenimiento(False)
            'Capturo datos de cabecera de ese formualario
    ...
    Private Sub mskFecDoc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles mskFecDoc.KeyPress
    ...
    Private Sub txtCtaCte_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCtaCte.LostFocus
        ...
        End Try
    End Sub
    Private Sub txtdocmodtip_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtdocmodtip.LostFocus
        Try
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        Try
            ...
            cDocModFec = If(IsDate(MskdocmodFecha.Text) = True, MskdocmodFecha.Text, "")
            ...
            If Me.accionMante = "N" Then
                a = objSql.Ejecutar2("sp_Con_Ins_Detalle_Voucher", gbcodempresa, gbano, gbmes, libro, nrovoucher, _
                                    ...
                                    txtdocmodtip.Text, txtdocmodNum.Text, cDocModFec, 0, "")
