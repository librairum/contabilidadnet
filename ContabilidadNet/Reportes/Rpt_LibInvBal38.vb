...
Public Class Rpt_LibInvBal38
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_LibInvBal38.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_LibInvBal38
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_LibInvBal38 = New Rpt_LibInvBal38()
        rpt.Site = Me.Site
        Return rpt
    End Function
