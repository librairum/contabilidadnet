...
Public Class maygener_saldos_it
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.maygener_saldos_it.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmaygener_saldos_it
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As maygener_saldos_it = New maygener_saldos_it()
        rpt.Site = Me.Site
        Return rpt
    End Function
