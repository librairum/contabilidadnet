...
Public Class Rpt_CostosDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_CostosDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ccm01cta() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_CostosDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CostosDetalle = New Rpt_CostosDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
