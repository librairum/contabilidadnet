...
Public Class rptconfdistribucion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptconfdistribucion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.rptconfdistribucion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cdic01emp() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cdic01aa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrptconfdistribucion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptconfdistribucion = New rptconfdistribucion()
        rpt.Site = Me.Site
        Return rpt
    End Function
