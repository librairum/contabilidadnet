...
Public Class maygener_Saldos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.maygener_Saldos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmaygener_Saldos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As maygener_Saldos = New maygener_Saldos()
        rpt.Site = Me.Site
        Return rpt
    End Function
