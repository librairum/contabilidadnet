...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub Traeimportacion()
        Try
            vistahelp = objSql.TraerDataTable("Spu_Con_Trae_cc01estructegpxanio", gbcodempresa).DefaultView
    ...
    Sub TraeEstructura()
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_cc01estructEGyPComp_PLE", gbcodempresa, "F", gbano).DefaultView
            ...
            Select Case indice
                Case 0
                    If txttipofila.Text = "" Then
                        lblhelp_0.Text = ""
                    Else
                        lblhelp_0.Text = Mod_BaseDatos.DameDescripcion("42" + txttipofila.Text, "GL")
                    End If
                Case 1
                    If txtsigno.Text = "" Then
                        lblhelp_1.Text = ""
                    Else
                        lblhelp_1.Text = Mod_BaseDatos.DameDescripcion("44" + txtsigno.Text, "GL")
                    End If
                Case 2
                    If txtgrupo.Text = "" Then
                        lblhelp_2.Text = ""
                    Else
                        lblhelp_2.Text = Mod_BaseDatos.DameDescripcion("45" + txtgrupo.Text, "GL")
                    End If
                Case 3
                    If txtfuente.Text = "" Then
                        lblhelp_3.Text = ""
                    Else
                        lblhelp_3.Text = Mod_BaseDatos.DameDescripcion("43" + txtfuente.Text, "GL")
                    End If
        ...
        Try
            ...
            Select Case index
                Case 0
                    ...
                    Me.TraeTablasGloables("42")
                Case 1
                    tblhelp.Columns(0).DataField = "glo01codigo"
                    tblhelp.Columns(1).DataField = "glo01descripcion"
                    Me.TraeTablasGloables("44")
                Case 2
                    tblhelp.Columns(0).DataField = "glo01codigo"
                    tblhelp.Columns(1).DataField = "glo01descripcion"
                    Me.TraeTablasGloables("45")
                Case 3
                    tblhelp.Columns(0).DataField = "glo01codigo"
                    tblhelp.Columns(1).DataField = "glo01descripcion"
                    Me.TraeTablasGloables("43")
                Case 4 'Importar
                    tblhelp.Columns(0).DataField = "cc01empresa"
                    tblhelp.Columns(1).DataField = "cc01anio"
                    Me.Traeimportacion()
            End Select
        ...
        Try
            Select Case indice
                Case 0
                    ...
                    txtsigno.Focus()
                Case 1
                    txtsigno.Text = tblhelp.Columns("glo01codigo").Value.ToString
                ...
                Case 4
                    ...
                    anioanterior = tblhelp.Columns(1).Value.ToString
                    ...
                    If MessageBox.Show("¿Esta Seguro de importar datos del año : " & anioanterior, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        a = objSql.Ejecutar2("Spu_Con_Ins_PerAntcc01estructegp", gbcodempresa, gbano, anioanterior, "")
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txtSaldo.Text = filaactiva("cc01Saldo").ToString
...
#End Region
    ...
    Private Sub Frm_LibLeg_EGyP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub eliminar()
        ...
        Try
            ...
            Dim a As Array = Array.CreateInstance(GetType(Object), 2, 10)
            a = objSql.Ejecutar2("Spu_Con_Del_cc01estructegp", gbcodempresa, gbano, correlativo, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        Dim grupo, signo, tipofila, fuente As String
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc01estructegp", gbcodempresa, gbano, correlativo, grupo, tipofila, signo, fuente, txtdescripcion.Text, CDbl(txtSaldo.Text.Trim), txtCodigoPLE.Text, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cc01estructegp", gbcodempresa, gbano, correlativo, grupo, tipofila, signo, fuente, txtdescripcion.Text, CDbl(txtSaldo.Text.Trim), txtCodigoPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            ElseIf accionMante = "I" Then
                a = objSql.Ejecutar2("Spu_Con_Inserta_cc01estructegp", gbcodempresa, gbano, correlativo, grupo, tipofila, signo, fuente, txtdescripcion.Text, CDbl(txtSaldo.Text.Trim), txtCodigoPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            Else
    ...
    Private Sub txttipofila_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txttipofila.LostFocus
        Me.TraeDameDescripcion(0)
    End Sub
    Private Sub txtfuente_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtsigno.KeyDown
        If e.KeyCode = Keys.F1 Then
    ...
    Private Sub txtgrupo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtgrupo.KeyDown
        ...
        End If
    End Sub
    Private Sub txtsubgrupo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtfuente.KeyDown
        If e.KeyCode = Keys.F1 Then
    ...
    Private Sub txtsubgrupo_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtfuente.LostFocus
        Me.TraeDameDescripcion(3)
    End Sub

    Private Sub txtfuente_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtsigno.LostFocus
        Me.TraeDameDescripcion(1)
    End Sub
    ...
    Private Sub txtfuente_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtsigno.TextChanged
    ...
    Private Sub txtsubgrupo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtfuente.TextChanged
