...
Public Class Rpt_LibInvBal32
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.Rpt_LibInvBal32.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cuentaEfectivo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_LibInvBal32
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_LibInvBal32 = New Rpt_LibInvBal32()
        rpt.Site = Me.Site
        Return rpt
    End Function
