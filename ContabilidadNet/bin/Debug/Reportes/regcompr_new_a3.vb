...
Public Class regcompr_new_a3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContabilidadNet.regcompr_new_a3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedregcompr_new_a3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As regcompr_new_a3 = New regcompr_new_a3()
        rpt.Site = Me.Site
        Return rpt
    End Function
