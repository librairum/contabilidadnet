...
Option Explicit On
Option Strict On
Public Class Frm_LibEstadoResultado
...
#Region "PROPIEDADES"
    ...
    Public Property p_RegistroActivo() As DataRowView
        ...
        End Set
    End Property
    Public Property p_Tiporeporte() As String
        Get
            Return Tiporeporte
        End Get
        Set(ByVal value As String)
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txtCodPLE.Text = filaactiva("cc01codrubroPLE").ToString
...
#End Region
    ...
    Private Sub tblhelp_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles tblhelp.LostFocus
        ...
        tblhelp.Visible = False
    End Sub
    Private Sub Frm_EEGGyPPCom_Conf_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            '
            Me.Text = Frm_LibrosLegales.rbtrepauxiliares_20.Text
            '
    ...
    Sub eliminar()
        ...
        Try
            ...
            a = objSql.Ejecutar2("Spu_Con_Del_cc01estructEGyPComp_PLE", gbcodempresa, "F", gbano, correlativo, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc01estructEGyPComp_PLE", gbcodempresa, "F", gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text.Trim, txtCodPLE.Text, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cc01estructEGyPComp_PLE", gbcodempresa, "F", gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text.Trim, txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            ElseIf accionMante = "I" Then
                a = objSql.Ejecutar2("Spu_Con_Inserta_cc01estructEGyPComp_PLE", gbcodempresa, "F", gbano, correlativo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text, txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            Else
    ...
    Private Sub txtgrupo_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.TraeDameDescripcion(2)
    End Sub

    Private Sub txtsubgrupo_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub txtgrupo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub txtsubgrupo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
