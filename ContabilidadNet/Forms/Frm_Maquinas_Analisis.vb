...
Option Strict On
Option Explicit On
Public Class Frm_Maquinas_Analisis

    Dim Vista As New DataView
    Private FilaDeTabla As DataRowView
    Dim filaactual As Integer
    Private Sub TraeMaquinas()
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_ccmmaquinas", gbcodempresa, gbano, "*", "").DefaultView
    ...
    Sub imprimir_verant(ByVal flagimpresion As String)
        ...
        Try
            ...
            '========================================
            nombredereporte = "rpt_MaquinasAnalisis.Rpt"
            ds = objSql.TraerDataSet("Spu_Con_Rep_MaquinasAna", gbcodempresa, gbano, gbmes, gbNameUser, gbNameUser, flagtiporeporte, flagopcionreporte, gbmoneda).Copy()
    ...
    Private Sub Frm_Maquinas_Analisis_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Try
            Me.Text = "Analisis de Trabjajos en Curso"
