...
Option Explicit On
Option Strict On
Public Class Frm_LibLeg_FluEfe
...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub Traeimportacion()
        Try
            vistahelp = objSql.TraerDataTable("Spu_Con_Trae_PerAntFluEfec", gbcodempresa).DefaultView
    ...
    Sub TraeEstructura()
        Try
            Vista = objSql.TraerDataTable("Spu_Con_Trae_cc01estructFluEfec", gbcodempresa, gbano, gbmes).DefaultView
            ...
            Select Case indice
                ...
                Case 4
                    ...
                    If MessageBox.Show("¿Esta Seguro de importar datos del año : " & anioanterior, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        a = objSql.Ejecutar2("Spu_Con_Ins_PerAntFluEfec", gbcodempresa, gbano, gbmes, anioanterior, mesanterior, "")
...
#End Region
    ...
    Private Sub Frm_LibLeg_Balgen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '
            Me.Text = Frm_LibrosLegales.rbtrepauxiliares_18.Text
    ...
    Sub eliminar()
        ...
        Try
            ...
            Dim a As Array = Array.CreateInstance(GetType(Object), 2, 10)
            a = objSql.Ejecutar2("Spu_Con_Del_cc01estructFluEfec", gbcodempresa, gbano, gbmes, correlativo, "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc01estructFluEfec", gbcodempresa, gbano, gbmes, correlativo, grupo, tipofila, fuente, subgrupo, txtdescripcion.Text, CDbl(txtSaldo.Text.Trim), txtCodPLE.Text, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cc01estructFluEfec", gbcodempresa, gbano, gbmes, correlativo, grupo, tipofila, fuente, subgrupo, txtdescripcion.Text, CDbl(txtSaldo.Text.Trim), txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            ElseIf accionMante = "I" Then
                a = objSql.Ejecutar2("Spu_Con_Inserta_cc01estructFluEfec", gbcodempresa, gbano, gbmes, correlativo, grupo, tipofila, fuente, subgrupo, txtdescripcion.Text, CDbl(txtSaldo.Text.Trim), txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            Else
