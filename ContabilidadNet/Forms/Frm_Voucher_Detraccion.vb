Option Explicit On
Option Strict On
Public Class Frm_Voucher_Detraccion
...
#Region "Traer Informacion de Base de Datos"
    ...
    Sub TraeDetracciones()
        Try
            VistaHelp = objSql.TraerDataTable("Sp_Glo_Trae_glo01tablas", "06", "GLO", "", "*").DefaultView
...
#Region "Mantenimiento"
    ...
    Sub AsignarAyuda(ByVal indice As Integer, ByVal tblhelp_p As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        Try
            Select Case indice
                Case 0
                    txttasa.Text = tblhelp_p.Columns("glo01codigo").Value.ToString
            ...
            Select Case indice
                Case 0
                    If txttasa.Text = "" Then
                        lblhelp_0.Text = ""
                    Else
                        lblhelp_0.Text = Mod_BaseDatos.DameDescripcion("06" + txttasa.Text.Trim, "GL")
                    End If
            End Select
    ...
    Sub cargarDatos(ByVal filaactiva As DataRowView)
        Try
            ...
            If Not filaactiva Is Nothing Then
                ...
                txttasa.Text = filaactiva("ccd01porcentaje").ToString
                Me.TraeDameDescripcion(0)

                TxtNroPago.Text = filaactiva("ccd01NroPago").ToString
                MskFecPago.Text = filaactiva("ccd01FecPago").ToString
            End If
        Catch ex As Exception
...
#End Region
    ...
    Sub eliminar()
        Try
            ...
            a = objSql.Ejecutar2("Sp_Con_Upd_detraccion", gbcodempresa, gbano, gbmes, voucherlibro, vouchernumero, "", "", "", "")
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If (lblhelp_0.Text = "" Or lblhelp_0.Text = "???") Then MessageBox.Show(gbc_MensajeValidar + "Tasa no valida", "", MessageBoxButtons.OK, MessageBoxIcon.Error) : txttasa.Focus() : Exit Sub
            If TxtNroPago.Text.Trim = "" Then MessageBox.Show(gbc_MensajeValidar + "Descripcion no valida", "", MessageBoxButtons.OK, MessageBoxIcon.Error) : TxtNroPago.Focus() : Exit Sub
            If Not IsDate(MskFecPago.Text) Then MessageBox.Show(gbc_MensajeValidar + "Fecha no valida", "", MessageBoxButtons.OK, MessageBoxIcon.Error) : MskFecPago.Focus() : Exit Sub
            ...
            If accionMante = "M" Then
                a = objSql.Ejecutar2("Sp_Con_Upd_detraccion", gbcodempresa, gbano, gbmes, voucherlibro, vouchernumero, TxtNroPago.Text, MskFecPago.Text, txttasa.Text, "")
                ' Asigno los Valores a los Parametros del Query
            Else
