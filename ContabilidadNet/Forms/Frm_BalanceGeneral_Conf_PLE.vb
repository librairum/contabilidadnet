Option Explicit On
Option Strict On
Public Class Frm_BalanceGeneral_Conf_PLE
    ...
    Private Sub btngrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngrabar.Click
        ...
        Try
            ...
            If accionMante = "N" Then
                a = objSql.Ejecutar2("Spu_Con_Ins_cc01estructbalgenComp_PLE", gbcodempresa, gbano, correlativo, grupo, subgrupo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text.Trim, txtCodPLE.Text, "")
            ElseIf accionMante = "M" Then
                a = objSql.Ejecutar2("Spu_Con_Upd_cc01estructbalgenComp_PLE", gbcodempresa, gbano, correlativo, grupo, subgrupo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text.Trim, txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            ElseIf accionMante = "I" Then
                a = objSql.Ejecutar2("Spu_Con_Inserta_cc01estructbalgenComp_PLE", gbcodempresa, gbano, correlativo, grupo, subgrupo, tipofila, fuente, txtdescripcion.Text, txtformula.Text.Trim, txtformula1.Text,txtCodPLE.Text, "")
                ' Asigno los Valores a los Parametros del Query
            Else
